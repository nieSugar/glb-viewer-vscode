...
### Fixed
 - Wrong texture file name after download
 - Bitmap not being displayed correctly in texture preview
 - Occlusion textures not being displayed in texture list

### Improved
  - If file is glTF, it can be opened as text to edit from the info panel
...
### Fixed
 ...
 - Camera focus on instanced meshes
...
### Improved
 ...
 - Clicking on a mesh name in the material window will select the mesh and open the details window

## [2.7.1] - 2025-08-12

### Fixed
 - Fixed issue when displaying highlighted instanced meshes
